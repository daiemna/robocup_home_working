...
def test_sensor_read(i2c_left, devices_config):
    read_seq = [10, INPUT, 0, 255, 255]
    i2c_left.writeSequence(read_seq)
    
    for i in range(1000):
        read = i2c_left.readNumber(at=2)
        log.debug("read pin data: {}".format(read))
